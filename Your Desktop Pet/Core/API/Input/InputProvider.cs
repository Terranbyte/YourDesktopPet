...
namespace Your_Desktop_Pet.Core.API.Input
{
    enum VirtualKey : int
    {
        ...
        //
        //OEM_1 = 0xBA,   // ';:' for US
        NUMPAD_PLUS = 0xBB,   // '+' any country
        NUMPAD_COMMA = 0xBC,   // ',' any country
        NUMPAD_MINUS = 0xBD,   // '-' any country
        NUMPAD_PERIOD = 0xBE,   // '.' any country
        //OEM_2 = 0xBF,   // '/?' for US
        //OEM_3 = 0xC0,   // '`~' for US
                           //
        //OEM_4 = 0xDB,  //  '[{' for US
    ...
    class InputProvider
    {
        private static VirtualKey _currentKey = VirtualKey.NONE;
        private static VirtualKey _lastKey = VirtualKey.NONE;
        ...
        {
            bool result = key != _lastKey && (GetAsyncKeyState((int)key) & WM_KEYDOWN) == WM_KEYDOWN;
        ...
        public static bool IsKeyHeld(VirtualKey key)
        {

            return (GetAsyncKeyState((int)key) & WM_KEYDOWN) == WM_KEYDOWN;
        }
